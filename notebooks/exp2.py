...
mlflow.set_tracking_uri("https://dagshub.com/vrushabh-09/EndToEnd_MLOps_FastAPI_Water_Potability_Prediction.mlflow")  # Registry URI for model management

# Load the dataset from CSV file and split into training and testing sets
data = pd.read_csv(r"D:\EndToEnd_MLOps_FastAPI_Water_Potability_Prediction\dataset\water_potability.csv")
...
with mlflow.start_run(run_name="Water Potability Models Experiment"):
    ...
    for model_name, model in models.items():
        ...
        with mlflow.start_run(run_name=model_name, nested=True):
            ...
            mlflow.set_tag("author", "Vrushabh Patil")
